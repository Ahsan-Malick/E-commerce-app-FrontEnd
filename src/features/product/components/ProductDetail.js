...
import { addtoCartAsync, postItemAsync, selectCartError, selectCartItems } from "../../cart/cartSlice";
import { selectError, selectLoggedUsers, selectUserInfo } from "../../auth/AuthSlice";
...
export default function ProductDetail() {
  ...
  const [selectedSize, setSelectedSize] = useState("medium");
   ...
   const { id: productId, price: productPrice } = 
   product&&Object.keys(product).length > 0 ? product: {}; //productID is a variable assigned to the value of id.


  const handleCart = (e)=>{
    e.preventDefault()
    dispatch(postItemAsync({product: productId, quantity:1, user: user.id,price:productPrice, totalPrice: productPrice}));
  }
            ...
            <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
              ...
              <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
                ...
                <h3 className="text-3xl font-bold mb-4">{product.title}</h3>
                  <h3 className="text-1xl font-bold mb-1">Description</h3>
